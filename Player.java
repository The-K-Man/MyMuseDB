 ...
 */
package museDB;
//File file = new File("C:\\Users\\kpari\\workspace\\museDB\\Pretty_Lights_-_Rainbows___Waterfalls.mp3");
import java.io.File;
...
public class Player extends BorderPane{
  ...
  public void selectVideo(File file, Stage stage){
    try {
        Media media = new Media(file.toURI().toString());
        media_player = new MediaPlayer(media);
        if(mediaView == null) {
        ...
        stage.setScene(new Scene(Vroot, 960, 540));
